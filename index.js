...
// NOTES
// function needs boolean
// console.log(originalFlavors.length); length is 31
// console.log(originalFlavors.length); added "Vanilla Swirl" to check if 32 and confirmed
...
function removeLastFlavor(flavor, originalFlavors){
...
console.log(originalFlavors.pop(removeLastFlavor))
...
console.log(originalFlavors, originFlavs)
